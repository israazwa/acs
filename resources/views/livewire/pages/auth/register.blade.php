...
<div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        <h2 class="text-2xl font-bold text-gray-800 text-center mb-6">Register Akun Baru</h2>
        ...
        <form wire:submit="register" class="space-y-5">
            ...
            <!-- Kode Unik -->
            <div>
                <x-input-label for="kode_unik" :value="__('Kode Unik Sekolah')" />
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <x-primary-button class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-lg shadow">
                    Register
                </x-primary-button>
            </div>
        </form>
